...
/**
 * Add all stirng literals to global variables
 * 
 */
void handleStrings()
{
...
{
    freopen("debug.txt", "w", stderr); //for printing  debugging flags
        ...
        if (curr.op == "label")
        {
            ...
            while (i < quadArr.quadarray.size())
            {
                ...
                else
                {
                    ...
                    //function body
                    /**
                     * @brief : Handle all the quads and map them one by one to assmbly
                     */ 
                    if (curr.op == "=" || curr.op == "=+")
                    {
                        ...
                        if (isNumber(curr.arg2))
                        {
                            ...
                            SymbolTableRow *arg1 = currST->lookup(curr.arg1);
                            if (arg1->isGlobal)  //in global case
                            {
